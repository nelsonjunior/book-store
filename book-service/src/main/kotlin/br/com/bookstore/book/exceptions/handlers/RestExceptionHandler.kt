package br.com.bookstore.book.exceptions.handlers

import br.com.bookstore.book.domain.dto.ExceptionResponseDTO
...
class RestExceptionHandler : ResponseEntityExceptionHandler() {
    ...
    fun handleEntityNotFoundException(ex: BookException): ResponseEntity<Any?>? {
        return ResponseEntity(
            ExceptionResponseDTO(
                HttpStatus.BAD_REQUEST.name,
                HttpStatus.BAD_REQUEST.reasonPhrase,
